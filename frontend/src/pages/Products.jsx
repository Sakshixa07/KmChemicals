...
export const Products = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0B] pt-20">
      ...
      {/* Category Filter */}
      <section className="py-12 bg-[#1a1a1a] sticky top-20 z-30 border-b border-[#D4AF37]/20">
            ...
            <button
              ...
              className={`px-6 py-3 rounded-lg font-semibold text-sm transition-all duration-300 ${
                selectedCategory === null
                  ...
                  : 'bg-white/5 text-white border border-[#D4AF37]/30 hover:border-[#D4AF37]/60'
              }`}
            >
              All Products
            </button>
            ...
            return (
              <div key={productCategory.id} className="mb-20 last:mb-0">
                ...
                <div className="flex items-center space-x-4 mb-10">
                  <div className="w-14 h-14 bg-[#D4AF37]/10 rounded-xl flex items-center justify-center border border-[#D4AF37]/30">
                    <Icon className="w-7 h-7 text-[#D4AF37]" />
                  </div>
                  <div>
                    <h2 className="text-3xl font-bold text-white">{productCategory.category}</h2>
                    <div className="h-1 w-20 bg-[#D4AF37] rounded-full mt-2"></div>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {productCategory.items.map((item, index) => (
                    <div
                      key={index}
                      className="group p-8 rounded-xl bg-gradient-to-br from-[#1a1a1a] to-[#0B0B0B] border border-[#D4AF37]/20 hover:border-[#D4AF37] transition-all duration-300 hover:shadow-2xl hover:shadow-[#D4AF37]/30 hover:transform hover:-translate-y-2"
                    >
                      <div className="flex items-start justify-between mb-4">
                        <h3 className="text-xl font-bold text-white group-hover:text-[#D4AF37] transition-colors">
                          {item.name}
                        </h3>
                        <div className="w-10 h-10 bg-[#D4AF37]/10 rounded-lg flex items-center justify-center group-hover:bg-[#D4AF37]/20 transition-colors border border-[#D4AF37]/30">
                      ...
                      <div className="pt-4 border-t border-[#D4AF37]/20">
                        <div className="text-xs font-semibold text-[#D4AF37] mb-2">APPLICATIONS:</div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-[#1a1a1a] via-[#0B0B0B] to-[#1a1a1a] border-t border-[#D4AF37]/20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            href="/contact"
            className="inline-block px-10 py-5 bg-[#D4AF37] text-[#0B0B0B] rounded-lg font-bold text-lg hover:bg-[#B8941F] transform hover:scale-105 transition-all duration-300 shadow-2xl shadow-[#D4AF37]/40"
          >
            Contact Our Experts
          </a>
        </div>
